...
export default function Service({image, about, more}){
    return(
        <>
            <div className="h-[300px] w-[300px] bg-white-200 pt-10 rounded rounded-2xl border border-l-0 border-r-0.5 border-b-0 border-t-0 border-gray-600 flex flex-col ">
