...
export default function C1(){
    return(
        ...
        <div className="flex flex-col justify-items-center dark:bg-black relative">
            <Image src={aboutusbg} alt="bg" className="relative w-sceern h-[100px] w-full object-cover"/>
            <div className="absolute text-[#826A45] ml-[40%] mt-10 text-1xl font-normal w-full text-center max-sm:ml-0 max-sm:text-sm">-------OUR TRUSTED 8K HAPPY PARTNER------</div>
